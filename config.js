...
module.exports = {
  ...
  SESSION_ID: (process.env.SESSION_ID || 'levanter_254d0ad5b043cd42a887472c48bf6337de').trim(),
  DATABASE:
  ...
  BRANCH: 'master',
  STICKER_PACKNAME: process.env.STICKER_PACKNAME || 'ODS-TECHNOLOGIES',
  ...
  MAX_UPLOAD: process.env.MAX_UPLOAD || 5000,
